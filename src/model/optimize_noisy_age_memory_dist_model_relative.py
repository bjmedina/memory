...
results = run_multi_start_minimize(
    ...
    method="Powell",
    out_dir="/om2/user/bjmedina/auditory-memory/memory/figures/human-results/isi-16-only/atexts-len120/noisyage_mixturemodel_relative",
    seed=123
)

# Save marginals for quick inspection later
save_marginals(results["eval_df"], out_dir="/om2/user/bjmedina/auditory-memory/memory/figures/human-results/isi-16-only/atexts-len120/noisyage_mixturemodel_relative", n_bins=30)
