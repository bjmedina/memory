#!/bin/bash
#SBATCH -J three-stage-compact-eval
#SBATCH -p mcdermott
#SBATCH -t 1-24:00:00
#SBATCH -n 1
#SBATCH -c 4
#SBATCH --mem=40G
#SBATCH --gres=gpu:1
#SBATCH -o logs/three-stage-compact-eval_%j.out
#SBATCH -e logs/three-stage-compact-eval_%j.err
...
NB_IN="notebooks/2026-02-26_three-stage-compact-eval.ipynb"
...
echo "=== Running three-stage-compact-eval notebook ==="
echo "Start: $(date)"
