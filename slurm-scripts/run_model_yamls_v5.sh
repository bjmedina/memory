...
YAML_DIR=/om2/user/bjmedina/auditory-memory/memory/model_yamls/v13_three-stage
...
python /om2/user/bjmedina/auditory-memory/memory/src/model/main_v5.py "$YAML_PATH"
