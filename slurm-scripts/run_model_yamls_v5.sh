...
YAML_DIR=/orcd/data/jhm/001/om2/bjmedina/auditory-memory/memory/model_yamls/v13_three-stage
...
python /orcd/data/jhm/001/om2/bjmedina/auditory-memory/memory/src/model/main_v5.py "$YAML_PATH"
