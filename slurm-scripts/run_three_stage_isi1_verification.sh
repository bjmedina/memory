...
#SBATCH --mem=40G
#SBATCH --gres=gpu:1
#SBATCH -o logs/three-stage-isi1-verification_%j.out
#SBATCH -e logs/three-stage-isi1-verification_%j.err
...
NB_IN="notebooks/2026-02-27_three-stage-compact-isi1-verification.ipynb"
